                ...
                <ul className="mb-2 flex flex-col gap-1.5 ml-3">
                  {item.menu.map((menu, index) => {
                    return menu.child.length > 0 ? (
                      ...
                      >
                        <div
                          className={`flex items-center gap-2.5 px-4 rounded-s-full py-2 hover:bg-zinc-100 hover:text-primary select-none relative hover:z-20 hover:font-bold menu-item w-full transition-all duration-0  ${
                            pathname === `${menu.path}`
