      ...
      {isLoadingProductDetail ? (
        ...
        <>
          <Row gutter={5}>
            ...
            <Col span={14}>
              ...
              <Row className='mt-1'>
                <Col span={12}>
                  <Typography>
                    Mã NhanhVN ID: <span className='font-bold'>{productDetail?.pages[0]?.nhanhVnId}</span>
                  </Typography>
                </Col>
              </Row>
              <Row className='mt-4'>
              ...
              <Row className='mt-4'>
                <Col span={12}>
                  <Typography>
                    Giá cũ :{' '}
                    <span className='font-bold'>{formatCurrencyVND(productDetail?.pages[0]?.oldPrice || 0)}</span>{' '}
                  </Typography>
                </Col>
                <Col span={12}>
                  <Typography>
                    Giá mới :{' '}
                    <span className='font-bold'>{formatCurrencyVND(productDetail?.pages[0]?.price || 0)}</span>{' '}
                  </Typography>
                </Col>
              </Row>
              {/* <Row className='mt-4'>
          ...
          <Typography>
            ...
            <span className='font-bold'>{`${productDetail?.pages[0]?.childProductDTOs?.length || 0} sản phẩm`}</span>
          </Typography>

          {productDetail?.pages[0]?.childProductDTOs && productDetail?.pages[0]?.childProductDTOs.length > 0 && (
            <Table
              rowKey='id'
