...
export default function UpdateCustomerPointModal({
  ...
  const [visibleModalUpdateCustomerPoint, setVisibleModalUpdateCustomerPoint] = useState<boolean>(false);
  ...
  const COLUMNS: TableColumn[] = [
    ...
    },
    {
      ...
      key: 'point',
      align: 'center',
      render: (_, record) => <span>{`${record.type === CalculatorPoint.ADDITION ? '+' : '-'} ${record.point}`}</span>,
    },
  ];
        ...
        <Row>
          <Col span={12}>
            <div className='flex items-center'>
              ...
              <Typography className='font-medium'>&nbsp;{customerDetail?.fullName || ''}</Typography>
            </div>
          </Col>
          <Col span={12}>
            <div className='flex items-center'>
              <Typography className='mr-3'>
                ...
                <span
                  className='font-bold'
                  style={{ color: customerDetail?.membershipDTO?.color || '#219653' }}
                >
