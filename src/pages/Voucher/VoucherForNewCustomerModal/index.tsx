...
import { Button, Col, Input, InputNumber, Modal, Radio, RadioChangeEvent, Row, Typography } from 'antd';
import { useEffect, useState } from 'react';
import { Controller, useForm } from 'react-hook-form';
import { toast } from 'react-hot-toast';
import { DiscountBy, Voucher, VoucherOverriding, VoucherPromotionType, VoucherSaleScope } from '~/models/voucher';
                  ...
                  <Controller
                    ...
                    render={({ field: { value, onChange } }) => (
                      <Radio.Group
                        ...
                        value={value}
                        className={`${
                          modalType === ModalType.UPDATE ? 'pointer-events-none cursor-not-allowed ' : ''
                        } `}
                        optionType='button'
                        buttonStyle='solid'
                        disabled={modalType === ModalType.UPDATE}
                ...
                >
                  ...
                  >
                    <label
                      ...
                      htmlFor='promotionType'
                    >
                      {`${watch('promotionType') === VoucherPromotionType.SALE ? 'Giảm giá theo' : 'Hoàn tiền theo'}`}
                    </label>
                  </Typography.Text>
                  <Radio.Group
                    ...
                    >
                      <Col span={24}>
                        ...
                        <Typography.Text
                          ...
                          className='!text-black text-[15px] font-medium'
                        >
                          {voucherById?.discountPercent ? Number(voucherById.discountPercent) + '%' : ''}
                        </Typography.Text>
                      </Col>
                    </Col>
                    <Col
                    ...
                    >
                      <Col span={24}>
                        ...
                        <Typography.Text
                          ...
                          className='!text-black text-[15px] font-medium'
                        >
                          {voucherById?.maxPromotion ? Number(voucherById.maxPromotion) + ' ' + 'đ' : ''}
                        </Typography.Text>
                      </Col>
                    </Col>
                  </Row>
                    ...
                    >
                      <Col span={24}>
                        ...
                        <Typography.Text
                          ...
                          className='!text-black text-[15px] font-medium'
                        >
                          {voucherById?.receivePointPercent ? Number(voucherById.receivePointPercent) + '%' : ''}
                        </Typography.Text>
                      </Col>
                    </Col>
                    <Col
