...
const UserModal = ({
  ...
  const [isShowInputUpdatePw, setIsShowInputUpdatePw] =
  ...
  const handleCheckRolePermission = (
    recordRole: UserRole,
    currentUserLoginRole: UserRole,
  ) => {
          ...
          <Row gutter={24}>
            ...
            <Col span={16}>
              ...
              <Row gutter={16} className="mt-5">
                {modalType != ModalType.INFORMATION ? (
                  ...
                  <Col span={12}>
                    ...
                    >
                      {user?.birthday
                        ? formatDate(user?.birthday, DATE_FORMAT_DDMMYYYY)
                        : ""}
                    </Typography.Text>
                  </Col>
                )}
              ...
              {isShowInputUpdatePw && modalType !== ModalType.INFORMATION && (
                <Row gutter={16} className="mt-1.5">
                  <Col span={12}>
                    <Typography.Text
                      type="secondary"
                      className="!text-black text-[14.5px]"
