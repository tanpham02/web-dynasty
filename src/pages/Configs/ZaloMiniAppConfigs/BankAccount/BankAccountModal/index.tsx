...
const BankAccountModal = ({ visible, modalType, onClose, refetchData, bankAccountById }: UserModalProps) => {
                  ...
                  >
                    <div className='mb-5.5'>
                      ...
                      {errors?.bankAccountName && (
                        <small className='text-danger text-[13px]'>Tên chủ tài khoản không được rỗng</small>
                      )}
                    </div>
                    <div className='mb-5.5'>
                      <label
                      ...
                      {errors?.bankAccountNumber && (
                        <small className='text-danger text-[13px]'>Số tài khoản không được rỗng</small>
                      )}
                    </div>
                    <div className='mb-5.5'>
                      <label
                      ...
                      />
                      {errors?.bankId && (
                        <small className='text-danger text-[13px]'>Tên ngân hàng không được rỗng</small>
                      )}
                    </div>
                  </form>
                </div>
