...
const frequentlyAskedQuestionService = {
  getFrequentlyAskedQuestion: async (params: SearchParams): Promise<ListResponse<FrequentlyAskedQuestion>> => {
    return axiosService()({
  ...
  getAllFrequentlyAskedQuestion: async (): Promise<FrequentlyAskedQuestion[]> => {
    return axiosService()({
  ...
  createFrequentlyAskedQuestion: async (data: FrequentlyAskedQuestion): Promise<FrequentlyAskedQuestion> => {
    return axiosService()({
  ...
  updateFrequentlyAskedQuestion: async (data: FrequentlyAskedQuestion): Promise<FrequentlyAskedQuestion> => {
    return axiosService()({
      url: `${FREQUENTLY_ASKED_QUESTION_URL}`,
      method: 'PATCH',
      data: data,
